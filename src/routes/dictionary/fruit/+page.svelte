...
<div class="p-4 w-full h-full flex flex-col items-center justify-center">
    <div class="w-1/2">
        ...
        <div class="w-full bg-gray-100 p-4 rounded-lg shadow-lg mt-4">
            ...
            <h2 class="text-3xl">Fruit</h2>
            <hr/>
            <p>The sweet and fleshy product of a tree or other plant that contains seed and can be eaten as food.</p>
            <br>

            <h3 class="text-2xl">Composition</h3>
            <hr/>

            <p><span class="font-skylang">I</span> is composed of the following keys :</p>
            <ul>
